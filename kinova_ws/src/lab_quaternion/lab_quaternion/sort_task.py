...
def main():
    ...
    poses = load_poses_from_csv("/home/shaolzr@netid.washington.edu/TECHIN516/kinova_ws/src/lab_quaternion/lab_quaternion/data_pick.csv")
